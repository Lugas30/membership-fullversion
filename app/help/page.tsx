        ...
        <div className="min-h-screen bg-white">
          <div className="flex flex-col bg-base-accent text-white rounded-b-3xl p-8">
            ...
            <p className="text-[10px] text-center tracking-wider my-6 fontMon leading-relaxed">
              ...
              eum eius error optio nulla assumenda eos sit, delectus itaque
              dolorem amet libero autem odio aliquam quibusdam ducimus animi hic
              pariatur natus ratione impedit quod!
            </p>
          </div>
